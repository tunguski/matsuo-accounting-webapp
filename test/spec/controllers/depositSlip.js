...
describe('DepositSlipCtrl', function () {
  ...
  describe('with print', function () {
    beforeEach(inject(function ($httpBackend, $rootScope, $controller) {
      ...
      var kw = {
        ...
        'printClass': 'pl.matsuo.clinic.model.print.cash.DepositSlip',
        'idEntity': 1,
      ...
      documentCtrl = $controller('DepositSlipCtrl', {$scope: scope, $routeParams: routeParams });
